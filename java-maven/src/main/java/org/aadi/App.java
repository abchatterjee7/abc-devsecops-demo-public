...
public class App {
    ...
    private static final String API_KEY = "ABC_DEMO_SECRET";

    public static void main(String[] args) throws Exception {

        // 2) Using System.out instead of logger (Maintainability)
        System.out.println("Starting ABC DevSecOps Project...");
        ...
        System.out.println("ABC DevSecOps app running on port " + port);
        server.start();
    }

    // simple helper method for tests
    public static String brandHtml() {
        return "<h1>Cloud With AB Chatterjee</h1><p>Simple DevSecOps Demo App</p>";
    }
}